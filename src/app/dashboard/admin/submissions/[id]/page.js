...
export default function SubmissionDetailPage({ params }) {
    ...
    if (!submission) return (
        <div className={styles.loadingScreen}>
            ...
            <Link href="/dashboard/admin/submissions" className={styles.backLink}>← Back to Submissions</Link>
        </div>
    );
    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.hero}>
                <Link href="/dashboard/admin/submissions" className={styles.backBtn}>
